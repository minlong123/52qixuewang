		...
		<div class="container-fluid">
		  ...
		  <div class="tab-content">
		    <div class="tab-pane active">
		    	<h2>管理员管理</h2>
		    	<?php if($_SESSION['id'] == 1): ?><a href="/index.php/Admin/Super/add" class="gl-mess btn btn-default btn-lg">增加管理员</a>
				...
				<table class="table table-bordered table-hover">
				  	<thead>
				  		<tr>
				  			<th class="success">#</th>
				  			<th class="success">管理员昵称</th>
				  			<th class="success">注册时间</th>
				  			<th class="success">上一次登录时间</th>
				  			<th class="success">上一次登录IP</th>
					...
					<tbody>
						...
						<?php if(is_array($super)): $i = 0; $__LIST__ = $super;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
							<td><?php echo ($vo["id"]); ?></td>
							<td><?php echo ($vo["username"]); ?></td>
							<td><?php echo (date('Y-m-d',$vo["register"])); ?></td>
							<td><?php echo (date('Y-m-d',$vo["logind"])); ?></td>
							<td><?php echo ($vo["ipd"]); ?></td>
							<td>
								<?php if($vo['id'] > 1): ?><a href="/index.php/Admin/Super/edit/id/<?php echo ($vo["id"]); ?>" class="btn btn-info">修改</a>

								<?php if(session('id') == 1): ?><a onclick="return confirm('确认删除吗?');" href="/index.php/Admin/Super/delete/id/<?php echo ($vo["id"]); ?>" class="btn btn-danger">删除</a>
								<?php else: endif; ?>
