				...
				<form class="form-inline" method="post">
				  <div class="form-group">
				    ...
				    <div class="input-group">
				      ...
				      <input type="text" class="form-control input-lg" id="exampleInputAmount" placeholder="请填写……" name="username">
				    </div>
				  </div>
				  <button type="submit" class="btn btn-primary btn-lg">添加</button>
				  <span class="add-user">密码默认为123456……</span>
				</form>
