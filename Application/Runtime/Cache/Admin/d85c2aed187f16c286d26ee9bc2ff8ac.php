		  ...
		  <div class="tab-content">
			...
			<form class="form-horizontal" method="post">
			  <div class="form-group">
			    ...
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="inputEmail3" placeholder="导航名……" name="linkname" value="<?php echo ($res["linkname"]); ?>">
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="inputPassword3" placeholder="url……" name="linkurl" value="<?php echo ($res["linkurl"]); ?>">
			    </div>
			  </div>
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-10">
			      <input type="input" class="form-control" id="inputPassword4" placeholder="导航排序……" name="sort" value="<?php echo ($res["sort"]); ?>">
			    </div>
			  </div>
